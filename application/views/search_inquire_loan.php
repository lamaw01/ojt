...
<html lang="en">
  ...
  <body>
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav nav-tabs">
                ...
                <?php if($this->session->userdata('level')==='1'):?>
                  ...
                  <li class="active"><a data-toggle="tab" href="<?php echo base_url('errors/loan');?>">Inquire Loan</a></li>
   ...
   <div class="container" id="srch-bar">
     <form method='post' action="<?= base_url() ?>search_inquire/loan">
      <div class="col-md-10">
   ...
   <table class="table table-striped" width="600" border="0" cellspacing="5" cellpadding="5">
    ...
    foreach($result as $data){
      ...
      $inquireln_acc_no = substr($data['inquireln_acc_no'],0, 180)."";
      $inquireln_old_acc_no = substr($data['inquireln_old_acc_no'],0, 180)."";
      $coreln_acc_name = substr($data['coreln_acc_name'],0, 180)."";
      $stat = substr($data['stat'],0, 180)."";
      ?>
      <tr>
      <td><p><?php print_r($inquireln_id); ?></p></td>
      <td><p><?php print_r($inquireln_acc_no); ?></p></td>
      <td><p><?php print_r($inquireln_old_acc_no); ?></p></td>
      <td><p><?php print_r($coreln_acc_name); ?></p></td>
      <td><p><?php print_r($stat); ?></p></td>
      <td><a class='btn btn-primary btn-md' href='<?php echo base_url()?>details/loan/<?php echo $inquireln_acc_no; ?>'>Details</a></td>
      </tr>
