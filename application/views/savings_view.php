            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav nav-tabs">
                ...
                <?php if($this->session->userdata('level')==='1'):?>
                  ...
                  <li class="active"><a data-toggle="tab" href="<?php echo base_url('savings');?>">Savings</a></li>
        ...
        <center>
          <div class="container container_size">
            ...
            <table class="table table-striped" width="600" border="0" cellspacing="5" cellpadding="5">
              ...
              <tr>
              <td><p><?php echo $row->migratedsv_id; ?></p></td>
              <td><p><?php echo $row->coresv_account_no; ?></p></td>
              <td><p><?php echo $row->mbwinsv_acc_no; ?></p></td>
              <td><p><?php echo $row->account_name; ?></p></td>
              <td><a class='btn btn-primary btn-md' href='<?php echo base_url()?>savings/callchecksv/<?php echo $row->migratedsv_id; ?>'>Check</a></td>
              </tr>
              ...
              if($this->uri->segment(2) == "callchecksv"){
                  $query = $this->db->query("call checkvalsv('$row->migratedsv_id')");
