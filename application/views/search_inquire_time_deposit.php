...
<html lang="en">
  ...
  <body>
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav nav-tabs">
                ...
                <?php if($this->session->userdata('level')==='1'):?>
                  ...
                  <li class="active"><a data-toggle="tab" href="<?php echo base_url('errors/loan');?>">Inquire Time Deposit</a></li>
   ...
   <div class="container" id="srch-bar">
     <form method='post' action="<?= base_url() ?>search_inquire/time_deposit">
      <div class="col-md-10">
   ...
   <table class="table table-striped" width="600" border="0" cellspacing="5" cellpadding="5">
    <tr style="background-color: grey;">
      <th><p>No.</p></th>
      <th><p>Account No.</p></th>
      <th><p>Old Account No.</p></th>
    ...
    foreach($result as $data){
      ...
      $inquiretd_acc_no = substr($data['inquiretd_acc_no'],0, 180)."";
      $inquiretd_old_acc_no = substr($data['inquiretd_old_acc_no'],0, 180)."";
      $coretd_acc_name = substr($data['coretd_acc_name'],0, 180)."";
      $stat = substr($data['stat'],0, 180)."";
      ?>
      <tr>
      <td><p><?php print_r($inquiretd_id); ?></p></td>
      <td><p><?php print_r($inquiretd_acc_no); ?></p></td>
      <td><p><?php print_r($inquiretd_old_acc_no); ?></p></td>
      <td><p><?php print_r($coretd_acc_name); ?></p></td>
      <td><p><?php print_r($stat); ?></p></td>
      <td><a class='btn btn-primary btn-md' href='<?php echo base_url()?>details/time_deposit/<?php echo $inquiretd_acc_no; ?>'>Details</a></td>
      </tr>
