            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav nav-tabs">
                ...
                <?php if($this->session->userdata('level')==='1'):?>
                  ...
                  <li class="active"><a data-toggle="tab" href="<?php echo base_url('page/inquire');?>">Inquire</a></li>
                <!--ACCESS MENUS FOR STAFF-->
                <?php elseif($this->session->userdata('level')==='2'):?>
                  <li><a data-toggle="tab" href="<?php echo base_url('page/tech');?>">Home</a></li>
                  <li><a data-toggle="tab" href="<?php echo base_url('page/check');?>">Check</a></li>
                  <li><a data-toggle="tab" href="<?php echo base_url('page/validated');?>">Validated</a></li>
                  <li class="active"><a data-toggle="tab" href="<?php echo base_url('page/errors');?>">Errors</a></li>
    ...
    <div class="container" id="div-chk-back">
      <div class="container-fluid">
        <div class="page-header" id="flesh">
            <h3 class="pargh"><strong>Inquire</strong></h3>
        </div>
      </div>
      <div class="container-fluid">
        <p class="pargh"><font size="3">Search for data</font></p>
      </div>
        <div id="div-marg">
          <form action="<?php echo site_url('choose/inquire');?>" method="post">
            <div class="container col-sm-4">
              <a value="1" class="this-size btn btn-lg btn-primary" href="<?php echo site_url('inquire/loan') ?>">Loan</a>
            </div>
            <div class="container col-sm-4">
              <a value="2" class="this-size btn btn-lg btn-success" href="<?php echo site_url('inquire/savings') ?>">Savings</a>
            </div>
            <div class="container col-sm-4">
              <a value="3" class="this-size btn btn-lg btn-warning" href="<?php echo site_url('inquire/time_deposit') ?>">Time Deposit</a>
            </div>
          </form>
        </div>
      </div>
