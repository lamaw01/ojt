...
<html lang="en">
  ...
  <body>
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav nav-tabs">
                ...
                <?php if($this->session->userdata('level')==='1'):?>
                  ...
                  <li class="active"><a data-toggle="tab" href="<?php echo base_url('page/validated');?>">Validated</a></li>
    ...
    <div class="container" id="div-chk-back">
      ...
      <div class="container-fluid">
        <p class="pargh"><font size="3">Display validated data</font></p>
      </div>
        <div id="div-marg">
          <form action="<?php echo site_url('choose/errors');?>" method="post">
            <div class="container col-sm-4">
              <a value="1" class="this-size btn btn-lg btn-primary" href="<?php echo site_url('validated/loan') ?>">Loan</a>
            </div>
            <div class="container col-sm-4">
              <a value="2" class="this-size btn btn-lg btn-success" href="<?php echo site_url('validated/savings') ?>">Savings</a>
            </div>
            <div class="container col-sm-4">
              <a value="3" class="this-size btn btn-lg btn-warning" href="<?php echo site_url('validated/time_deposit') ?>">Time Deposit</a>
            </div>
          </form>
        </div>
      </div>
