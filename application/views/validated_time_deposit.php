    ...
    <div class="container-fluid">
      ...
      <center>
        <div class="container" id="srch-bar">
         <form method='post' action="<?= base_url() ?>search_validated/time_deposit">
          <div class="col-md-10">
       ...
       <br>
          <div class="container container_size divTB">
            <table class="table table-striped" width="600" border="0" cellspacing="5" cellpadding="5">
              ...
              <tr>
              <td><p><?php echo $row->validatetd_id; ?></p></td>
              <td><p><?php echo $row->val_coretd; ?></p></td>
              <td><p><?php echo $row->val_mbwintd; ?></p></td>
              <td><p><?php echo $row->coretd_acc; ?></p></td>
              <td><a class='btn btn-primary btn-md' href='<?php echo base_url()?>details/time_deposit/<?php echo $row->val_coretd; ?>'>Details</a></td>
