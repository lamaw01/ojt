...
<html lang="en">
  ...
  <body>
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav nav-tabs">
                ...
                <?php if($this->session->userdata('level')==='1'):?>
                  ...
                  <li class="active"><a data-toggle="tab" href="<?php echo base_url('errors/loan');?>">Inquire Savings</a></li>
   ...
   <div class="container" id="srch-bar">
     <form method='post' action="<?= base_url() ?>search_inquire/savings">
      <div class="col-md-10">
   ...
   <table class="table table-striped" width="600" border="0" cellspacing="5" cellpadding="5">
    ...
    foreach($result as $data){
      ...
      $inquiresv_acc_no = substr($data['inquiresv_acc_no'],0, 180)."";
      $inquiresv_old_acc_no = substr($data['inquiresv_old_acc_no'],0, 180)."";
      $coresv_acc_name = substr($data['coresv_acc_name'],0, 180)."";
      $stat = substr($data['stat'],0, 180)."";
      ?>
      <tr>
      <td><p><?php print_r($inquiresv_id); ?></p></td>
      <td><p><?php print_r($inquiresv_acc_no); ?></p></td>
      <td><p><?php print_r($inquiresv_old_acc_no); ?></p></td>
      <td><p><?php print_r($coresv_acc_name); ?></p></td>
      <td><p><?php print_r($stat); ?></p></td>
      <td><a class='btn btn-primary btn-md' href='<?php echo base_url()?>details/savings/<?php echo $inquiresv_acc_no; ?>'>Details</a></td>
      </tr>
