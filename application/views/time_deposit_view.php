        ...
        <center>
          <div class="container container_size">
            ...
            <table class="table table-striped" width="600" border="0" cellspacing="5" cellpadding="5">
              ...
              <tr>
              <td><p><?php echo $row->migratedtd_id; ?></p></td>
              <td><p><?php echo $row->coretd_account_no; ?></p></td>
              <td><p><?php echo $row->mbwintd_acc_no; ?></p></td>
              <td><p><?php echo $row->account_name; ?></p></td>
              <td><a class='btn btn-primary btn-md' href='<?php echo base_url()?>time_deposit/callchecktd/<?php echo $row->migratedtd_id; ?>'>Check</a></td>
              </tr>
              ...
              if($this->uri->segment(2) == "callchecktd"){
                  $query = $this->db->query("call checkvaltd('$row->migratedtd_id')");
